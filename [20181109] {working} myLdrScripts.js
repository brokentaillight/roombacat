...
var myLdrScripts = {
	...
	// main:	
		...
		var _boss = getUnit(1, getLocaleString(2853)); 				// infectore
		...
		Attack.clear(18, 0, false, false, true);
		Pather.usePortal(null, me.name);
		...
		if(_boss) Pather.moveTo((_boss.x + rand(10,15)), (_boss.y + rand(10,15)));
		Pather.makePortal();
		...
		this.clearCowLevel = function () {
			...
			while (rooms.length > 0) {
				...
				if (result) {
					...
					delay(250);
					Skill.cast(78, 0, (me.x + rand(5,11)), (me.y + rand(5,11)));	// bonewall
					delay(250);
